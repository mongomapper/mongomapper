...
Since MongoDB is schema-less, models specify the schema for a document. Each document is made up of keys. Keys are named and type-casted so you know your data is stored in the correct format.
