...
Instead of just using the default "fire and forget" behavior on our save operation, passing the @:safe@ option to @save@ will for the driver to make sure the save succeeds and raise an error if it doesn't.
