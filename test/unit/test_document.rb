...
class DocumentTest < Test::Unit::TestCase
  ...
  context "An instance of a document" do
    ...
    context "#reload" do
      should "update nil attributes and instance variables to be nil in the reloaded document object when they don't exist as attributes in the mongo document" do
        reloaded_doc_klass = Doc("ReloadDoc") do
          key :my_cool_string,  String
        end

        doc = reloaded_doc_klass.create!(:my_cool_string => "scott")
        another_doc = doc.class.find(doc.id)
        another_doc.my_cool_string.should == doc.my_cool_string

        doc.update_attributes(:my_cool_string => nil)

        another_doc.reload
        another_doc.my_cool_string.should be_nil
        another_doc.instance_variable_get(:@my_cool_string).should be_nil
      end
    end
