...
class ManyProxyTest < Test::Unit::TestCase
  ...
  context "Finding scoped to association" do
    setup do
      ...
      @brand_new         = Status.create(:name => 'New', :item_order => 1 )
      @complete          = Status.create(:name => 'Complete', :item_order => 2)
    ...
    context "with :all" do
      should "work" do
        @project1.statuses.find(:all, :order => "item_order asc").should == [@brand_new, @complete]
      end
    ...
    context "with #all" do
      should "work" do
        @project1.statuses.all(:order => "item_order asc").should == [@brand_new, @complete]
      end
    ...
    context "with :last" do
      should "work" do
        @project1.statuses.find(:last, :order => "item_order asc").should == @complete
      end
    ...
    context "with #last" do
      should "work" do
        @project1.statuses.last(:order => "item_order asc").should == @complete
      end
